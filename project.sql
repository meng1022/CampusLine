...
-- ----------------------------
-- Table structure for execution_result
-- ----------------------------
DROP TABLE IF EXISTS `execution_result`;
CREATE TABLE `execution_result`  (
  `mutation_point_id` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `status` int(11) NULL DEFAULT NULL,
  `duration` int(11) NULL DEFAULT NULL,
  `stdout` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
